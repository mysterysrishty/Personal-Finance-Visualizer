  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-purple-100 to-white px-4 overflow-x-hidden">
      ...
      <div className="flex flex-col md:flex-row bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200 max-w-3xl w-full overflow-hidden animate-fade-in-up min-h-[520px] z-10 glass">
        {/* Illustration / Icon */}
        <div className="hidden md:flex flex-col items-center justify-center w-full md:w-1/2 bg-gradient-to-br from-purple-500 to-blue-600 p-10 min-h-[520px]">
          <FaUserPlus className="text-white text-6xl mb-4 animate-pulse" />
          <h2 className="text-2xl font-bold text-white mb-2">Create Account</h2>
          <p className="text-white text-base text-center">
            Register to start tracking your expenses and budgets securely.
          </p>
        </div>
        {/* Form */}
        <form
        ...
        >
          ...
          <div className="relative mb-2">
            ...
            <input
              type="email"
              className="w-full pl-10 pr-4 py-3 rounded-xl border-2 border-gray-200 focus:ring-4 focus:ring-purple-100 focus:border-purple-400 bg-white placeholder-gray-400"
              value={email}
          ...
          <div className="relative mb-2">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-3 rounded-xl border-2 border-gray-200 focus:ring-4 focus:ring-blue-100 focus:border-blue-400 bg-white placeholder-gray-400"
              value={password}
